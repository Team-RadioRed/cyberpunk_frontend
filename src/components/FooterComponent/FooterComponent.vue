...
.footer_wrapper {
  ...
  .footer_list {
    ...
    .footer_item {
      position: relative;
      display: flex;
      //background: no-repeat url('@/assets/svg/footer_item_bg-odd.svg');
      ...
      &::before {
        content: url('@/assets/svg/footer_item_bg-odd.svg');
        position: absolute;
        top: -10px;
        left: -32px;
        z-index: -1;
